...
import com.ben.gank.view.RadioImageView;
 ...
 *
 */
public abstract class GirlAdapter extends ArrayRecyclerAdapter<Image, GirlAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(R.layout.item_list_girl, parent);
    }
